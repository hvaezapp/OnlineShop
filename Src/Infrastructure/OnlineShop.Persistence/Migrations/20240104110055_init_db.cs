        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountExpireAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAddOn_AddOn_AddOnId",
                        column: x => x.AddOnId,
                        principalTable: "AddOn",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductAddOn_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAddOn_AddOnId",
                table: "ProductAddOn",
                column: "AddOnId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAddOn_ProductId",
                table: "ProductAddOn",
                column: "ProductId");
